...
cmd({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://api.github.com/repos/bot-deploy-main/");
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your 𝚂𝙷𝙰𝚅𝙸𝚈𝙰-𝙼𝙳 bot is already up-to-date!");
        }
        ...
        const { data: zipData } = await axios.get("https://github.com/bot-deploy-main/", { responseType: "arraybuffer" });
