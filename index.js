...
const port = process.env.PORT || 9090;
  ...
  let up = `*✨ Hello, 𝚂𝙷𝙰𝚅𝙸𝚈𝙰-𝙼𝙳 Legend! ✨*
...
> _© Made By 𝚂𝙷𝙰𝚅𝙸𝚈𝙰-𝙳𝙴𝚅_`;
    conn.sendMessage(conn.user.id, { image: { url: `https://tinyurl.com/28ewpzw2` }, caption: up })
  }
  })
  ...
  conn.sendMessage(from, { text: teks }, { quoted: mek })
    ...
    const jawad = ('94707085822', '94758127752');
  ...
  if(senderNumber.includes("94707085822")){
  if(isReact) return
  m.react("👾")
   }
...
if (!isReact && senderNumber === botNumber) {
 ...
 await conn.newsletterReactMessage(`@newsletter`, id, randomEmoji);
 ...
 if (isBanned) return; 
  ...
  app.get("/", (req, res) => {
  res.send("𝚂𝙷𝙰𝚅𝙸𝚈𝙰-𝙼𝙳 IS  STARTED ✅");
  });
